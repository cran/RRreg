...
The package `RRreg` contains the function `getPW` to obtain this misclassification matrix for the implemented designs. The forced response design with proabilities `P=c(.1,.2)`, for instance, can be described by:
